...
class Review:
    ...
    def save(self):
        """ Insert a new row with the star_rating, restaurant_id, and customer id values of the current Review object.
        Update object id attribute using the primary key value of new row.
        Save the object in local dictionary using table row's PK as dictionary key"""
        sql = """
                INSERT INTO reviews (star_rating, restaurant_id, customer_id)
                VALUES (?, ?, ?)
        """

        CURSOR.execute(sql, (self.star_rating, self.restaurant_id, self.customer_id))
        CONN.commit()
    ...
    def create(cls, star_rating, restaurant_id, customer_id):
        ...
        review = cls(star_rating, restaurant_id, customer_id)
        review.save()
        return review
